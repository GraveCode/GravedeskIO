module.exports = {
	"standardClose": "This job ticket with the IT Support team has now been closed, as we believe the reported issue has been resolved. Thank you."

	"customClose": "This ticket has now been closed.\n\n" +
		"***\n\n"

	"newAutoReply": "----- _PLEASE ONLY REPLY ABOVE THIS LINE_\n\nThank you for reporting your issue to IT support. It has been added to our list as a new job ticket, and we will look into it as soon as possible.\n\n" +
		"You can reply to this email (above the line) to add new information to the same ticket.\n\n" +
		"_Your message:_\n" +
		"***\n\n"

	"existingAutoReply": "----- _PLEASE ONLY REPLY ABOVE THIS LINE_\n\nThank you for adding more information to your ticket.\n\n" +
		"_Your message:_\n" +
		"***\n\n"
